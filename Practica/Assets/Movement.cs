...
public class Movement : MonoBehaviour
{
    ...
    public void Move(float move, bool crouch, bool jump, bool climbing, bool grabing)
    {
        ...
        if (m_Grounded || m_AirControl)
        {
            ...
            if (climbing && jump && m_FacingRight)
            {
                m_Grounded = false;
                m_Rigidbody2D.velocity = new Vector2(0f, 0f);
                m_Rigidbody2D.AddForce(new Vector2(-750f, m_JumpForce));
            } else if (climbing && jump && !m_FacingRight)
            {
                m_Grounded = false;
                m_Rigidbody2D.velocity = new Vector2(0f, 0f);
                m_Rigidbody2D.AddForce(new Vector2(750f, m_JumpForce));
